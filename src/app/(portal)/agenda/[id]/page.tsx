...
export default function EventDetailPage(): React.JSX.Element {
  ...
  return (
    <div className="w-full space-y-8">
      <BackButton fallbackHref="/agenda" label="Voltar para agenda" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="sticky top-24 rounded-sm border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#141416] p-6 sm:p-8 space-y-6 shadow-sm">
          <div>
            ...
            <div className="w-full bg-zinc-100 dark:bg-zinc-800 h-2 rounded-sm overflow-hidden mt-3">
              <div
          ...
          <div className="space-y-3">
            <button
              ...
              className={`w-full py-3.5 px-4 rounded-sm text-xs font-bold uppercase tracking-wider transition-all shadow-xs cursor-pointer flex items-center justify-center gap-2 ${
                isConfirmed
