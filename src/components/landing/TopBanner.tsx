      ...
      <div className="w-full max-w-440 mx-auto flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-6 text-center">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="group relative inline-flex items-center justify-center px-4 py-1.5 overflow-hidden rounded-none bg-[#FF6847] text-white text-xs font-bold uppercase tracking-wider shadow-xs whitespace-nowrap cursor-pointer transition-all duration-300"
          >
