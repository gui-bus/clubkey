    ...
    <section className="py-24 relative overflow-hidden bg-muted/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Veja o que nossos associados dizem sobre a facilidade, curadoria e economia real em suas viagens.
          </motion.p>
        </div>
              ...
              <div className="pt-6 border-t border-border/50 flex items-center gap-3.5">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">
                    {item.role} • <span className="text-amber-600 dark:text-amber-400 font-medium">{item.destination}</span>
                  </div>
                </div>
              </div>
            </motion.div>
