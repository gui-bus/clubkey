      ...
      >
        ...
        <Container className="relative z-20 pt-28 pb-12 sm:pt-32 sm:pb-14 md:pt-36 md:pb-16 flex flex-col items-center text-center">
          <div className="max-w-3xl flex flex-col items-center text-center w-full">
            ...
            <h1 className="flex flex-col items-center gap-1 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight text-white leading-[1.1] mb-3 font-heading drop-shadow-md">
              <span className="text-white">Bem-vindo(a),</span>
              <span className="text-brand-primary">{userProfile.name}</span>
            </h1>
