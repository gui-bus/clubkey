...
- **`lib/docs/[component_name].md`**

Whenever you are working with an installed component, you MUST read its specific markdown file (e.g. `lib/docs/button.md` or `lib/docs/carousel.md`) to check the exact props, types, defaults, and code examples before writing or refactoring code.
