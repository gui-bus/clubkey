...
export default function RoomDetailPage(): React.JSX.Element {
  ...
  return (
    <main className="min-h-screen bg-[#FAF9F5] dark:bg-[#0c0c0c] text-zinc-900 dark:text-zinc-100 flex flex-col font-sans selection:bg-[#FF6847]/20">
      <TopBanner />
      <Navbar isTransparent={false} />

      <div className="w-full max-w-[1720px] mx-auto px-4 sm:px-8 md:px-12 lg:px-16 pt-6 pb-24">
        {}
        ...
        {}
        <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-md mb-12 bg-zinc-200 dark:bg-zinc-800">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 aspect-[4/3] sm:aspect-[16/9] md:aspect-[22/9]">
            {}
            <div
          ...
          <div className="lg:col-span-5 xl:col-span-4">
            <div className="p-6 sm:p-7 rounded-3xl bg-white dark:bg-[#161616] border border-zinc-200 dark:border-zinc-800 shadow-xl flex flex-col gap-6">
              ...
              <button
                ...
                className="w-full py-3.5 px-6 rounded-2xl bg-[#FF6847] hover:bg-[#E85535] active:scale-98 text-white font-bold text-sm sm:text-base shadow-lg shadow-[#FF6847]/25 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
