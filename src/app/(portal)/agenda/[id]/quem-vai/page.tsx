          ...
          return (
            ...
            >
              <div className="flex items-start gap-4">
                {member.image ? (
                  <div className="relative w-14 h-14 shrink-0 rounded-sm overflow-hidden bg-zinc-900 ring-1 ring-zinc-200 dark:ring-zinc-800">
                    <Image
                      src={member.image}
                      alt={member.name}
                      fill
                  ...
                  <div className="w-14 h-14 shrink-0 rounded-sm bg-zinc-900 dark:bg-zinc-800 text-white flex items-center justify-center font-black text-sm ring-1 ring-zinc-200 dark:ring-zinc-700">
              ...
              <div className="space-y-2 pt-3 border-t border-zinc-100 dark:border-zinc-800">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {member.offering.map((tag) => (
                    <span
                      key={tag}
                      className="px-2.5 py-1 rounded-sm text-xs font-semibold bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 border border-zinc-200/60 dark:border-zinc-700"
                    >
                      {tag}
                    </span>
                  ))}
