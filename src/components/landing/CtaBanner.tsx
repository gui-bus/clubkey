        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6">
            ...
            <p className="text-stone-300 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
              Ative sua Key hoje mesmo, desbloqueie até{" "}
              <strong className="text-white font-bold">60% de desconto</strong>{" "}
              em milhares de hotéis e resorts de alto padrão e aproveite
              benefícios em 150 países.
            </p>
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                <Button
                  ...
                  startContent={
                    <Key className="w-5 h-5 stroke-[2.5] text-stone-950" />
                  }
