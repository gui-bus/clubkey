...
export function RoomsSearchFilterBar({
  ...
  return (
    <motion.div
      ...
      ref={searchBarRef}
      className="relative z-40 w-full max-w-4xl bg-white dark:bg-[#1a1a1a] rounded-sm sm:rounded-full shadow-2xl p-2 sm:p-2.5 flex flex-col sm:flex-row items-center justify-between gap-2 border border-zinc-200/80 dark:border-zinc-800"
    >
      <div className="relative flex-1 w-full">
        <button
          ...
          className="w-full flex items-center justify-between gap-2.5 px-4 py-2.5 sm:py-2 rounded-sm sm:rounded-full hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors text-left cursor-pointer"
        >
        ...
        {destinationOpen && (
          <div className="absolute top-full left-0 mt-3 w-full sm:w-84 bg-white dark:bg-[#1e1e1e] rounded-sm shadow-2xl border border-zinc-200 dark:border-zinc-800 z-[100] overflow-hidden text-left animate-in fade-in zoom-in-95 duration-150">
      ...
      <button
        ...
        className="flex-1 w-full sm:w-auto flex items-center gap-2.5 px-4 py-2.5 sm:py-2 rounded-sm sm:rounded-full hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors text-left cursor-pointer"
      >
      ...
      {calendarOpen && (
        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-full max-w-[95vw] md:max-w-4xl bg-white dark:bg-[#1a1a1a] rounded-sm shadow-2xl border border-zinc-200 dark:border-zinc-800 z-[100] p-4 sm:p-6 text-left animate-in fade-in zoom-in-95 duration-150">
